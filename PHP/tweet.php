...
if($selected == "posttweet") {
	...
	// Query to add the tweet to the database
	      ...
	      die($conn->error);
				...
				while ($getTweetsResult = $getTweetsCheck->fetch_array()) {
					...
					echo "<div class=\"c\">";
						...
						echo"<div class=\"lower\"><button  id=\"reply\" class=\"fa fa-lock\" onclick=\"#nothing\"> Replys</button><span class=\"lower-right\">" . $getTweetsResult['date'] . "</div>";
